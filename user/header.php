  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                 <a class="nav-link active" aria-current="page" href="#"><img src="hed.png" alt="logo" style="width: 150px; height: 40px;"></a>

        
        
      </ul>
      <a href="index.php" class="text-warning text-decoration-none pe-2"><i class="fa-solid fa-house"></i>Home</a>
      <a href="" class="text-warning text-decoration-none pe-2"><i class="fa-solid fa-cart-shopping"></i>Cart(0)</a>

      <span class="text-warning pe-2">
      <i class="fa-solid fa-user-group"></i>Hello |
